...
import org.hisp.dhis.android.trackercapture.reports.ReportsFragment;
...
public class HolderActivity extends AbsHomeActivity {
    ...
    public static final String ARG_TYPE_REPORTFRAGMENT = "arg:ReportFragment";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        switch (argType) {
            ...
            case ARG_TYPE_REPORTFRAGMENT:{

                ReportsFragment reportsFragment = new ReportsFragment();
                onBackPressedListener = reportsFragment;
...
//        intent.setFlags(intent.getFlags() | Intent.FLAG_ACTIVITY_NO_HISTORY); // we don't want to keep it to backstack
    ...
    //this method was added by ifhaam on 28/12/2017 for icmr
    //household member enrollment and relating at the same time
    public static void navigateToEnrollmentDataEntryFragment(Activity activity, String orgUnitId,
                                                             String programId,
                                                             String dateOfEnrollment,
    ...
    public static void navigateToReportFragment(Activity activity){
        Intent intent = new Intent(activity,HolderActivity.class);
        intent.putExtra(ARG_TYPE,ARG_TYPE_REPORTFRAGMENT);
        activity.startActivity(intent);
    }
